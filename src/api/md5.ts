// Compact, dependency-free MD5 (RFC 1321) for Subsonic token auth:
// token = md5(password + salt). Lets us authenticate and then store only the
// salt + token, never the raw password.
...
function toBlocks(bytes: number[]): number[] {
...
export function md5(input: string): string {
  const x = toBlocks(utf8Bytes(input));
  let a = 1732584193;
  let b = -271733879;
  let c = -1732584194;
  let d = 271733878;
